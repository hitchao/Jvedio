        ...
        public static class AppData
        {
            ...
            static AppData()
            {
                ...
                TABLES.Add("common_images",
                    ...
                    ");");
                TABLES.Add("common_translations",
                ...
                TABLES.Add("common_search_histories",
                    "BEGIN; " +
                        "create table common_search_histories ( ID INTEGER PRIMARY KEY autoincrement, " +
                        ...
                        "UpdateDate VARCHAR(30) DEFAULT(STRFTIME('%Y-%m-%d %H:%M:%S', 'NOW', 'localtime')) " +
                    "); " +
                    "CREATE INDEX common_search_histories_idx_SearchMode_SearchField_CreateYear_CreateMonth_CreateDay ON " +
                        "common_search_histories (SearchMode,SearchField,CreateYear,CreateMonth,CreateDay); " +
                    "CREATE INDEX common_search_histories_idx_SearchMode_SearchField_CreateDate ON " +
                    "   common_search_histories (SearchMode,SearchField,CreateDate); " +
                    "COMMIT;");
                TABLES.Add("common_tagstamp",
                    "BEGIN; " +
                    "create table common_tagstamp ( " +
                        ...
                        "UpdateDate VARCHAR(30) DEFAULT(STRFTIME('%Y-%m-%d %H:%M:%S', 'NOW', 'localtime')) " +
                    "); " +
                    "insert into common_tagstamp(Background,Foreground,TagName) " +
                    "values('154,88,183,255','255,255,255,255','HD'),('154,205,50,255','255,255,255,255','Translated'); " +
                    "COMMIT;");
                TABLES.Add("common_association",
                    "BEGIN; " +
                    ...
                    "COMMIT;");
                TABLES.Add("common_picture_exist",
                    "BEGIN; " +
            ...
            static Data()
            {
                TABLES.Add("metadata",
                    ...
                    "create table if not exists metadata ( " +
                        ...
                        "DBId INTEGER, Title TEXT, " +
                        "Size  INTEGER DEFAULT 0, " +
                        "Path TEXT, Hash VARCHAR(32), " +
                        "Country VARCHAR(50), " +
                ...
                TABLES.Add("metadata_video",
                    ...
                    "COMMIT;");
                TABLES.Add("metadata_to_translation",
                    "BEGIN; " +
